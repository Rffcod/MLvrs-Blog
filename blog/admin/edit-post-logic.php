...
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        $_SESSION['edit-post'] = "Tidak dapat memperbarui postingan. Data formulir tidak valid pada halaman edit postingan";
    } elseif (!$category_id) {
        $_SESSION['edit-post'] = "Tidak dapat memperbarui postingan. Data formulir tidak valid pada halaman edit postingan";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "Tidak dapat memperbarui postingan. Data formulir tidak valid pada halaman edit postingan";
        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 2000000) {
                    ...
                    $_SESSION['edit-post'] = "Tidak dapat memperbarui postingan. Ukuran thumbnail terlalu besar. Harus kurang dari 2mb";
                }
            } else {
                $_SESSION['edit-post'] = "Tidak dapat memperbarui postingan. Thumbnail harus png, jpg atau jpeg";
            }
        }
    }
    ...
    if ($_SESSION['edit-post']) {
        ...
        // set thumbnail name if a new one was upload, else keep old thumbnail name
    ...
    if (!mysqli_errno($connection)) {
        $_SESSION['edit-post-success'] = "Postingan berhasil diupdate";
    }
}
